"""
Django settings for ChatBotWebApp project.
...
SECRET_KEY = '1cbi7^z($bm6f^9x!v3u^@0o#sl7yezw!sn(i&a@tfpyju%&a$'
...
ROOT_URLCONF = 'ChatBotWebApp.urls'
...
WSGI_APPLICATION = 'ChatBotWebApp.wsgi.application'
...
EMAIL_HOST_USER = 'weiyuxinexponential@gmail.co'
